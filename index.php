  ...
  <script src="js/moment.min.js"></script>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12" style="margin-top: 20px; box-shadow: 5px 5px 10px rgba(0,0,0,0.2); overflow: hidden; padding-top: 10px;">
